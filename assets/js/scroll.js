(function ($) {
  ...
  function naylaMouseCursor(init) {
    ...
    if (mouseCursor.length) {
      ...
      let cursorText = mouseCursor
          .children(".mouse-cursor-text")
          .wrapInner("<span></span>"),
  ...
  function pageLoader() {
    if ($(".page-loader").length) {
      ...
      countLabels.forEach((element) =>
        $(".page-loader-count").append(
          '<span class="count_' + element + '">' + element + "</span>"
        )
      );
  ...
  function naylaHeader() {
    ...
    function fixedHeader() {
      ...
      ScrollTrigger.create({
        trigger: $("body").hasClass("smooth-scroll")
          ? "#smooth-content"
          : "body",
        start: fixedStart,
        end: "bottom bottom",
      ...
      if (topPin.length) {
        ...
        ScrollTrigger.create({
          ...
          onLeave: () => {
            ...
            siteHeader.hasClass("sticky-dark")
              ? siteHeader.addClass("dark")
              : siteHeader.removeClass("dark");
            siteHeader.hasClass("sticky-light")
              ? siteHeader.addClass("light")
              : siteHeader.removeClass("light");
  ...
  function siteNavigation() {
    ...
    function classicNavigation() {
      ...
      var resetHeader = gsap.delayedCall(0.7, headerLayoutChange, [
        false,
        false,
        false,
        true,
      ...
      if (nav.length) {
        nav.each(function () {
          ...
          menuItems.each(function () {
            ...
            link.wrapInner(
              '<span class="hov_span" data-text="' + link.text() + '"></span>'
            );
          });
        });
      }
    ...
    function menuItemAnims(menu, direction) {
      menu.each(function () {
        let items = $(this).children("li"),
          targets = [
            items.children("a").find(".mt_char"),
            items.children(".sub-toggle"),
          ],
    ...
    function fullscreenNavigation() {
      ...
      if (nav.length) {
        hasChildren.each(function () {
          ...
          $(this).append(
            '<span class="sub-toggle">(' + childLength + ")</span>"
          );
        });

        mainMenu.append(
          '<span class="sub-close"><span class="material-icons">close</span></span>'
        );
    ...
    function menuToggle(targetMenu) {
      ...
      var headerReset = gsap.delayedCall(1, headerLayoutChange, [
        false,
        false,
        false,
        true,
      ...
      setTimeout(function () {
        let navTweens = gsap.getTweensOf(
            targetMenu
              .find("*")
              .not(".main-menu *, .nayla-button, .nayla-button *")
          ),
          i = 0,
          tltl = gsap.timeline({
            id: "fs_menu_tl",
          ...
          for (i = 0; i < navTweens.length; i++) {
            if (navTweens[i]) {
              if (navTweens[i].parent) {
                ...
                navTweens[i].parent.scrollTrigger !== null
                  ? navTweens[i].parent.scrollTrigger.kill()
                  : "";
                tltl.add(navTweens[i], 0 + i / 10);
              } else {
                navTweens[i].pause();
                navTweens[i].scrollTrigger !== null
        ...
        menuToggle.on("click", function () {
          ...
          if (clicks) {
            ...
            let activeMenu = targetMenu.find(
              "ul.menu.active, ul.sub-menu.active"
            );
  ...
  class naylaGeneralAnimations {
    ...
    constructor(DOM_el, options, fromOptions, scroll, out) {
      ...
      if (
        activeAnimation[0] === "fadeUp" ||
        activeAnimation[0] === "fadeDown"
      ) {
        this.from.opacity = 0;
      ...
      if (
        activeAnimation[0] === "fadeLeft" ||
        activeAnimation[0] === "fadeRight"
      ) {
        this.from.opacity = 0;

        activeAnimation[0] === "fadeLeft"
          ? (this.from.xPercent = 100)
          : (this.from.xPercent = -100);
      ...
      if (
        activeAnimation[0] === "slideRight" ||
        activeAnimation[0] === "slideLeft"
      ) {
        let leftVal = this.target.offset().left + this.target.outerWidth(),
          rightVal =
            $(window).outerWidth() - leftVal + this.target.outerWidth();

        activeAnimation[0] === "slideRight"
          ? (this.from.x = -1 * leftVal)
          : (this.from.x = rightVal);
      ...
      if (this.pin) {
        ...
        this.scroll.scrollTrigger.end =
          this.duration == null
            ? "botom top"
            : "bottom+=" + this.duration * 1000 + " top";
      }
  ...
  function naylaParallaxImages() {
    ...
    image.each(function () {
      let $this = $(this),
        ...
        speed =
          $this.data("parallax-speed") == null
            ? 60
            : $this.data("parallax-speed"),
    ...
    constructor(DOM_el, options, fromOptions, scroll, out) {
      ...
      if (
        ...
        if (bg === "auto") {
          ...
          $(this.DOM.el)
            .find(".block-ov")
            .css("backgroundColor", $(this.DOM.el).data("block-color"));
        }
  ...
  class naylaTextAnimation {
    ...
    constructor(DOM_el, options, fromOptions, scroll, out) {
      ...
      activeAnimation[0].includes("Justify")
        ? (this.type = "lines, words")
        : "";
      ...
      if (
        activeAnimation[0] === "charsScaleUp" ||
        activeAnimation[0] === "charsScaleDown"
      ) {
        this.from.scaleY = 0;
      ...
      if (activeAnimation[0] === "slideLeft") {
        ...
        this.animOut
          ? (this.defaults.x = -1 * $(window).outerWidth() - 400)
          : "";
        this.animOut ? (this.out.ease = "none") : "";
      ...
      if (activeAnimation[0] === "slideRight") {
        ...
        if (this.target.outerWidth() > $(window).outerWidth()) {
          this.defaults.x =
            0 - (this.target.outerWidth() - $(window).outerWidth() + 300);
        } else {
          this.defaults.x = 0;
        }
    ...
    render() {
      ...
      this.tl.eventCallback("onComplete", () => {
        ...
        this.scrub != true && !this.noRevert && loader == null
          ? this.split.revert()
          : "";
  ...
  function naylaTextAnims() {
    ...
    hasAnim.not(exclude).each(function () {
      ...
      if (
        $this.hasClass("wordsJustifyCollapse") ||
        $this.hasClass("wordsJustifyExpand")
      ) {
        let words = $this.find(".anim_word"),
          start =
            $this.offset().top < $(window).outerHeight()
              ? 0
              : "top bottom+=200",
  ...
  function naylaProductPage() {
    ...
    matchMedia.add(
      ...
      (context) => {
        ...
        var galeryDrag = Draggable.create(
          gallery.find(".product-gallery-wrap"),
          {
            type: "x",
            bounds: {
              minX: 0,
  ...
  function naylaProjectPages() {
    ...
    if (header.hasClass("image-gallery")) {
      ...
      if (horizontal) {
        ...
        tl.to(
          header.find(
            ".project-category, .project-meta, .project-slide-button"
          ),
          {
            opacity: 0,
          },
        ...
        slideButton.on("click", function () {
          let scrollToo =
            750 *
            Math.ceil(
              ScrollTrigger.getById("projectImagesScroll").progress * 10
            );
      ...
      function createSeperators(lengths) {
        ...
        if (!portfolio.hasClass("masonry")) {
          ...
          for (i = 1; i < lengths; i++) {
            i % columns == 0
              ? $(line).insertAfter(
                  projectsWrapper.find(
                    '.grid-project:visible[data-current-index="' + i + '"]'
                  )
                )
              : "";
          }
      ...
      if (portfolio.hasClass("filterable")) {
        ...
        filterCats.each(function () {
          ...
          id == "all"
            ...
            : (length = portfolio.find("." + id).length);
          ...
          $this.on("click", () => {
            ...
            if (id === "all") {
              ...
              let visibleLength =
                projectsLength - projects.not("." + id).length;

              portfolio.hasClass("grid-list")
                ? ""
                : createSeperators(visibleLength);
            }
      ...
      switchList.on("click", () => {
        ...
        gsap.to(projects, {
          ...
          onComplete: () => {
            ...
            $(
              '<span class="g-list-arrow material-icons">arrow_outward</span>'
            ).insertBefore(
              projects.find(
                ".grid-project-wrap .grid-project-meta > div:last-child"
              )
            );
      ...
      switchGrid.on("click", () => {
        ...
        gsap.to(portfolio.find(".grid-project-meta > *"), {
          ...
          onComplete: () => {
            ...
            let currLength = projectsWrapper.find(
  ...
  function showcaseWall() {
    ...
    wallWrap.each(function () {
      ...
      var layoutReset = gsap.delayedCall(
        0.1,
        layoutChange,
        [overlay, false, wrapper],
        {
          oncomplete: () => {
      ...
      project.each(function (i) {
        ...
        $this.find("a").on("mouseenter", function () {
          ...
          mainWrap.hasClass("animate-colors")
            ? layoutChange(overlay, $this, wrapper)
            : "";
        });
  ...
  function showcaseList() {
    ...
    sflWrap.each(function () {
      ...
      if ($this.hasClass("animate-in")) {
        $this
          .find(".project-title")
          .addClass("has-anim-text charsScaleDown fade");
    ...
    fullscreenSlideshow.each(function () {
      ...
      projects.each(function (i) {
        ...
        image
          ...
          .wrapInner(
            '<div class="fs-parallax-wrap"><div class="slide-bgimg"></div></div>'
          )
          ...
          on: {
            slideChange: function () {
              let swiper = this,
                ...
                projectOut = fsSlideshow.find(
                  ".project_" + swiper.previousIndex
                ),
  ...
  function showcaseMinimalList() {
    ...
    mainWrap.each(function () {
      ...
      if (mainWrap.hasClass("infinity")) {
        project
          .clone()
          .addClass("clone clone-next")
          .appendTo(projectsWrap.find(".sml-wrap"));

        project
          .clone()
          .addClass("clone clone-prev prev-el")
          .prependTo(projectsWrap.find(".sml-wrap"));

        let prevHeight =
            mainWrap.find(".clone-prev").length *
            mainWrap.find(".clone-prev").innerHeight(),
      ...
      project.each(function (i) {
        ...
        if (!$this.hasClass("clone")) {
          ...
          image
            .addClass("image_" + (i - mainWrap.find(".clone-prev").length))
            .appendTo(images);

          $this.addClass(
            "project_" + (i - mainWrap.find(".clone-prev").length)
          );
        }
      });
      ...
      window.addEventListener("scroll", function () {
        let progY =
          (scrollY / speed) * (project.outerHeight(true) * projectsLength);
        gsap.set(projectsWrap, {
          y: startY - progY,
        });
  ...
  function showcaseCarousel() {
    ...
    mainWrap.each(function () {
      ...
      let firstPos =
          $(window).outerWidth() / 2 - $(".project_0").outerWidth() / 2 + 75,
      ...
      matchMedia.add(
        ...
        (context) => {
          ...
          let scDrag = Draggable.create(scWrap, {
            ...
            onThrowUpdate: () => {
              ...
              if (prog <= 0) {
                ...
                $(".project-image.swiper-slide").removeClass(
                  "transition--media"
                );
                $(".image_" + slideGo).addClass("transition--media");
              } else if (prog >= 0) {
          ...
          return () => {
            ...
            ScrollTrigger.getById("showcaseCarouselScroll").vars.end =
              lastPos * -1;
          };
        }
      );
    ...
    showcaseFullscreenCarousel.each(function (i) {
      ...
      var titlesSlider = new Swiper(".fc-slideshow-wrap", {
        ...
        imagesSlider = new Swiper(".fc-images-slider", {
          ...
          on: {
            ...
            slideChangeTransitionEnd: function () {
              let index =
                $(".showcase-project.swiper-slide-active").data("index") + 1;
      ...
      var titlesDrag = Draggable.create(dragger, {
        ...
        onPress: (self) => {
          ...
          if (colorAnim == true) {
            let project = projectsWrap.find(
              ".showcase-project.swiper-slide-active"
            );
            layoutChange(overlay, project, projectsWrap);
          }

          gsap.to(
            [siteHeader, mainWrap.find(".showcase-footer, .sfc-fraction")],
            {
              opacity: 0,
              duration: 0.3,
            }
        ...
        onRelease: (self) => {
          ...
          let activeProj = projectsWrap
            .find(".showcase-project.active")
            .data("index");
    ...
    grid.each(function () {
      ...
      projects.each(function (i) {
        let $this = $(this),
          left =
            $this.offset().left +
            ($this.offset().left > $(window).outerWidth() / 2 ? 75 : 0),
          top =
        ...
        left > $(window).outerWidth() / 2
          ? $this.addClass("project-right")
          : $this.addClass("project-left");
      ...
      cards.find(".anim-project").each(function (i) {
        tl.to(
          $(this),
          {
            ...
            onUpdate: () => {
              let cloneItem = cards.find(
                ".clone-project_" + $(this).data("index")
              );

              gsap.set(cloneItem, {
                ease: "none",
                y:
                  $(this).css("transform").split(",")["13"] -
                  cards.find(".clone").length * 30,
                z:
                  $(this).css("transform").split(",")["14"] -
                  cards.find(".clone").length * 100,
              });
            },
          },
          0
        ...
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            let findProj = ".project_" + Math.ceil(self.progress * projLength),
              findImage =
                ".project_image_" + Math.ceil(self.progress * projLength),
    ...
    function createNav(range, length, index) {
      ...
      function detectActive() {
        $items.each(function () {
          ...
          entrance < center && center < deadLine
            ? $this.addClass("active")
            : $this.removeClass("active");
        ...
        $lightbox
          .find(".lf-curr")
          .html($(".lightbox-thumb.active").data("index") + 1);
      }
      ...
      thumbsWheeler.wheel(function (event, delta, deltaX, deltaY) {
        ...
        xVal = Math.min(
          Math.max(-range + $items.last().outerWidth() / 2, xVal),
          -$items.first().outerWidth() / 2
        );
    ...
    $(items).each(function (i) {
      ...
      $this.on("click", () => {
        if (!$gallery.hasClass("lightbox-active")) {
          ...
          const result = $items
            .toArray()
            .reduce((a, item) => a + Math.floor($(item).outerWidth()), 10);
  ...
  function naylaDynamicGrid() {
    ...
    grid.each(function () {
      ...
      grid.hasClass("lightbox-gallery")
        ? grid.css("height", grid.outerHeight())
        : "";

      grid.hasClass("lightbox-gallery")
        ? naylaLightboxGallery(wrapper, items)
        : "";
  ...
  function naylaDynamicCarousel() {
    ...
    carousel.each(function () {
      ...
      val = 0;
        ...
        wrapper.outerWidth() -
        items.last().outerWidth() -
        items.last().outerWidth() / 2;
      ...
      items.each(function (i) {
        ...
        if (carousel.hasClass("parallax-on")) {
          ...
          $this
            .find(".parallax-wrap")
            .css("height", $this.find("img").outerHeight());
          $this
            .find(".parallax-wrap")
            .css("width", $this.find("img").outerWidth());

          $this
            .find("img")
            .css(
              "width",
              mobileQuery.matches ? "calc(100% + 50px)" : "calc(100% + 100px)"
            );
        ...
        if (animation != null) {
          ...
          carousel.hasClass("image-carousel")
            ? new naylaImageAnimation($this)
            : new naylaGeneralAnimations($this);
        }
      });
      ...
      function getCurrentItem() {
        items.each(function () {
          ...
          !activeItem.next().length
            ? next.addClass("disabled")
            : activeItem.next().addClass("next");
          !activeItem.prev().length
            ? prev.addClass("disabled")
            : activeItem.prev().addClass("prev");

          activeItem.data("index") == null
            ? ""
            : carousel
                .find(".carousel--current")
                .html(activeItem.data("index") + 1);

          if (carousel.hasClass("parallax-on")) {
            let piv =
              ScrollTrigger.positionInViewport(this, "right", true) *
              (mobileQuery.matches ? 50 : 100);
        ...
        wrapScroll = gsap.timeline({
          scrollTrigger: {
            ...
            start: start,
              ...
              carousel.offset().top < $(window).outerHeight()
                ? endNumber
                : endtrigger,
            pin: true,
            id: "caroScroll",
        ...
        if (siteHeader.hasClass("sticky") || siteHeader.hasClass("fixed")) {
          if (
            ...
            ScrollTrigger.create({
              ...
              onEnter: () =>
                headerLayoutChange(sectionLayout, false, false, false),
              onEnterBack: () =>
                headerLayoutChange(sectionLayout, false, false, false),
    ...
    if (video.length && !video.hasClass("vid-ready")) {
      video.each(function (i) {
        ...
        $this.data("controls") != false
          ? (controls = $this.data("controls").split(" "))
          : "";
            ...
            $(".lightbox-close").on("click", function () {
              gsap.to(".nlv", {
                ...
                onComplete: () => {
                  ...
                  vid
                    .find(".plyr__video-wrapper")
                    .removeClass("nayla-video-wrap");
                  vid
                    .find(".plyr__controls")
                    .removeClass("nayla-controls-wrap");
              ...
              if ($this.hasClass("ratio-adjusted")) {
                ...
                let rat =
                    naylaVid.ratio.split(":")[0] / naylaVid.ratio.split(":")[1],
        ...
        if (
          $this.parents(".has-anim").length &&
          $this.parents(".project-page").length
        ) {
          setTimeout(function () {
            let anim = gsap.getTweensOf($this.parents(".has-anim"));

            anim[0].parent.pause();
            anim[0].parent.scrollTrigger !== null
              ? anim[0].parent.scrollTrigger.kill()
              : "";
  ...
  function naylaCircleText() {
    ...
    circularText.each(function (i) {
      ...
      if (dataIcon) {
        $this.append(
          "<div class='circular-text-icon'><span class='material-icons'>" +
            dataIcon +
            "</span></div>"
        );
      }
      ...
      if (dataSeperator) {
        ...
        seperator.wrapInner(
          '<span class="material-icons">' + dataSeperator + "</span>"
        );
  ...
  function naylaButtons() {
    ...
    button.each(function () {
      ...
      if (animation) {
        $this.wrapInner(
          '<span class="button-anim-holder has-anim-text ' +
            animation +
            '"></span>'
        );
      ...
      button.hasClass("underline")
        ? $this.append('<span class="button-line"></span>')
        : "";
    });
  }
  ...
  function naylaServices() {
    ...
    naylaServices.each(function () {
      ...
      servicesItem.append(
        "<span class='services-item-bottom-line nayla-service-line'></span>"
      );
      ...
      servicesItem.each(function (i) {
        ...
        var $this = $(this),
          ...
          calcEnd =
            siteHeader.hasClass("sticky") || siteHeader.hasClass("fixed")
              ? siteHeader.outerHeight() + 50
              : 50,
          start =
            siteHeader.hasClass("sticky") || siteHeader.hasClass("fixed")
        ...
        services.hasClass("ordered")
          ? titleWrap.attr("data-index", "(" + index + ")")
          : "";
  ...
  function naylaAccordion() {
    ...
    naylaAccordion.each(function () {
      ...
      acrdTitle.append(
        '<span class="material-icons accordion-toggle">' + icon + "</span>"
      );
  ...
  function naylaTestimonials() {
    ...
    testimonials.each(function () {
      ...
      avatars.append(
        '<svg height="100%" width="100%" viewbox="0 0 100 100"><circle cx="50" cy="50" r="40" /></svg>'
      );
      ...
      if (ctStart.length == 1) {
        tl.to(
          ctStart,
          {
            y: 0,
            duration:
              $this.data("duration") == null ? 2.5 : $this.data("duration"),
            ease: "expo.out",
          },
          0
        );
  ...
  function naylaTeamMember() {
    ...
    member.each(function () {
      ...
      image.append(
        '<div class="cv-toggle"><span class="material-icons">add</span></div>'
      );
          ...
          onStart: () => {
            ...
            tl.to($this.find(".tab-content"), {
              ...
              onComplete: () => {
                ...
                $this
                  .find(".tab-content.data-index_" + $(this).data("index"))
                  .show();
              },
            });

            tl.to(
              $this.find(".tab-content.data-index_" + $(this).data("index")),
              {
                opacity: 1,
                duration: $this.data("duration") / 2,
              }
  ...
  function projectBackground(current, next, tl, delay, smooth) {
    if (current === next) {
      ...
      if (
        $(".animating").find(".n-vimeo").length ||
        $(".animating").find(".n-youtube").length
      ) {
        ov.style.zIndex = 0;
      }
  ...
  function projectImageLeave(tl, media) {
    ...
    let margTop = parseInt(
        media.parents(".elementor-section").last().css("marginTop"),
        10
      ),
      margBottom = parseInt(
        media.parents(".elementor-section").last().css("marginBottom"),
        10
      );
  ...
  function projectImageEnter(tl, response, targetBg) {
    ...
    if (
      transImage.find(".n-vimeo").length ||
      transImage.find(".n-youtube").length
    ) {
      tl.to(
        transImage,
        {
      ...
      },
      {
        ...
        from: {
          custom: ({ trigger }) => {
            return (
              trigger.classList &&
              trigger.classList.contains("inner-project-link")
            );
          },
        },
        to: {
      ...
      },
      {
        ...
        from: {
          custom: ({ trigger }) => {
            return (
              trigger.classList &&
              trigger.classList.contains("showcase-project-link")
            );
          },
        },
        to: {
      ...
      },
      {
        ...
        from: {
          custom: ({ trigger }) => {
            return (
              trigger.classList &&
              trigger.classList.contains("grid-project-link")
            );
          },
        },
        to: {
          ...
          return new Promise(function (resolve, reject) {
            ...
            tl.to(window, {
              ...
              onComplete: () => {
                ...
                if (
                  media.find(".n-vimeo").length ||
                  media.find(".n-youtube").length
                ) {
                } else {
                  $("body").hasClass("smooth-scroll")
                    ? media.insertBefore("#smooth-content")
      ...
      },
      {
        ...
        from: {
          custom: ({ trigger }) => {
            return (
              trigger.classList &&
              trigger.classList.contains("next-project-link")
            );
          },
        },
        to: {
        ...
        leave() {
          return new Promise(function (resolve, reject) {
            ...
            let media = $(".next-project-image"),
              ...
              targets = [
                "div.next-project-caption , .next-project-title, .next-project-metas",
              ],
        ...
        beforeEnter(data) {
          return new Promise(function (resolve, reject) {
            ...
            let image = response.find(
                ".project-page-header .project-image.featured"
              ),
              top =
                image.offset().top -
                $("main").first().outerHeight() -
  ...
  $(document).ready(function () {
    $(
      ".inner-project-link, .next-project-link, .grid-project-link, .menu-link, .sc-link, .showcase-project-link"
    ).on("click", () => {
      //            startLoading()
    });
  });
